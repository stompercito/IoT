                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mb-3">Comparación Anual</h4>
                                <canvas id="sales-chart" height="420" width="840" class="chartjs-render-monitor" style="display: block; width: 280px; height: 140px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
